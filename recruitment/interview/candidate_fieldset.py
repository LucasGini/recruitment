default_fieldsets = (
    (None, {'fields': ("userid", ("username", "city", "phone"), ("email", "apply_position", "born_address"),
                       ...
                       ("major", "degree"), ("test_score_of_grneral_ability"), ("paper_score",), "last_editor")}),
    ('第一轮面试记录', {'fields': (
    ...
    "hr_advantage", "hr_disadvantage", "hr_result", "hr_recommend_position", "hr_interviewer_user", "hr_remark")})
)

default_fieldsets_frist = (
    ((None, {'fields': ("userid", ("username", "city", "phone"), ("email", "apply_position", "born_address"),
                        ("gender", "candidate_remark"), ("bachelor_school", "master_school", "doctor_school"),
                        ("major", "degree"), ("test_score_of_grneral_ability"), ("paper_score",), "last_editor")}),
     ('第一轮面试记录', {'fields': (
