...
# HR终面结论
HR_SCORE_TYPE = ((u'S', u'S'), (u'A', u'A'), (u'B', u'B'), (u'C', u'C'))
...
class Candidate(models.Model):
    ...
    # 综合能力测评成绩，笔试测评成绩
    test_score_of_grneral_ability = models.DecimalField(decimal_places=1, null=True, max_digits=3, blank=True,
    ...
    first_result = models.CharField(max_length=128, choices=FIRST_INTERVIEW_RESULT_TYPE, blank=True,
                                    verbose_name='初试结果')
    ...
    first_remark = models.CharField(max_length=128, blank=True, verbose_name='初试备注')
    ...
    second_result = models.CharField(max_length=128, choices=INTERVIEW_RESULT_TYPE, blank=True,
                                     verbose_name='专业复试结果')
    ...
    second_interviewer_user = models.ForeignKey(User, related_name='second_interviewer_user', blank=True, null=True,
                                                on_delete=models.CASCADE, verbose_name='面试官')
    second_remark = models.CharField(max_length=128, blank=True, verbose_name='专业复试备注')

    # HR终面
    hr_score = models.CharField(max_length=12, choices=HR_SCORE_TYPE, blank=True, verbose_name='HR复试综合等级')
    hr_responsibility = models.CharField(max_length=12, choices=HR_SCORE_TYPE, blank=True, verbose_name='HR责任心')
    hr_communication_ability = models.CharField(max_length=12, choices=HR_SCORE_TYPE, blank=True, verbose_name='HR坦诚沟通')
    hr_logic_ability = models.CharField(max_length=12, choices=HR_SCORE_TYPE, blank=True, verbose_name='HR逻辑思维')
    hr_potential = models.CharField(max_length=12, choices=HR_SCORE_TYPE, blank=True, verbose_name='HR发展潜力')
    hr_stability = models.CharField(max_length=12, choices=HR_SCORE_TYPE, blank=True, verbose_name='HR稳定性')
    ...
    hr_result = models.CharField(max_length=128, choices=INTERVIEW_RESULT_TYPE, blank=True,verbose_name='HR复试结果')
    hr_recommend_position = models.CharField(max_length=256, blank=True, verbose_name='建议方向或推荐部门')
    hr_interviewer_user = models.ForeignKey(User, related_name='hr_interviewer_user', blank=True, null=True,
                                            on_delete=models.CASCADE, verbose_name='面试官')
    hr_remark = models.CharField(max_length=128, blank=True, verbose_name='HR复试备注')

    creator = models.CharField(max_length=256, blank=True,verbose_name='候选人数据的创建')
    created_date = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
    modified_date = models.DateTimeField(auto_now=True, null=True, blank=True, verbose_name='更新时间')
    last_editor = models.CharField(max_length=256, blank=True,verbose_name='最后的编辑者')
